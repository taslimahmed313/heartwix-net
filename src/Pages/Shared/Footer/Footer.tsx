    ...
    <div>
      <footer className="footer p-10 bg-base-200 text-base-content">
        <div>
          ...
          <a className="link link-hover">heartwix-net Ltd. Navana Tower (7th Floor)</a>
          <a className="link link-hover">45 Gulshan South C/A, Circle-1</a>
          <a className="link link-hover">Tel : (8802) 222264415, (880) 9611123123</a>
          <a className="link link-hover">Email : info@heartwix-net.com.bd</a>
        </div>
        <div>
          <span className="footer-title">Quick Links</span>
          <a className="link link-hover">Hosting & Development</a>
          <a className="link link-hover">Corporate Internet</a>
          <a className="link link-hover">Home Internet</a>
          <a className="link link-hover">Coverage Area</a>
        </div>
        <div>
          <span className="footer-title">Quick Links</span>
          <a className="link link-hover">Special Offer</a>
          <a className="link link-hover">Bill Pay</a>
      ...
      <footer className="footer items-center p-4 bg-base-200 border-base-300">
